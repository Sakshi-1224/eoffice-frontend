...
const Layout = () => {
  ...
  return (
    ...
    <div className="flex min-h-screen bg-slate-50 font-sans text-slate-900">
      ...
      {/* Sidebar: Professional Dark Navy (Solid, not transparent) */}
      <aside className="w-68 flex flex-col h-screen fixed left-0 top-0 z-10 bg-slate-900 text-white shadow-xl">
        <div className="p-6 border-b border-slate-800">
          <h1 className="text-xl font-bold tracking-wide text-white">
            e-Office
          </h1>
          <p className="text-[10px] text-slate-400 uppercase tracking-wider mt-1">Maharashtra Mandal Raipur</p>
        </div>
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-900">
          ...
          <button 
            onClick={logout}
            className="flex items-center gap-2 w-full px-3 py-2 text-xs font-bold text-red-400 hover:bg-red-500/10 rounded-lg transition-colors uppercase"
          >
